...
const resList = [
 ...
 //I have to expoort this file to my Body as it code shows error:ReferenceError: resList is not defined
 //normal export below  ,there are two types of export:noraml and named 
 //In one file we can only use one degault export 
